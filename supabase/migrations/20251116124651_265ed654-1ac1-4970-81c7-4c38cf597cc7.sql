-- Fix: public.get_highlights — suppression h.provider inexistant, cast h.type, starts_at enrichi
...
COMMENT ON FUNCTION public.get_highlights IS 'Récupère les highlights avec scoring. provider=null, join via match_highlightly_id, fixture_id=m.id.';