...
const MOCK_GAMES: MockGame[] = [
  // Real Ludo (not mock) - with real image
  { id: 'ludo', name: 'Ludo', category: ['popular', 'multiplayer'], image: 'https://images.unsplash.com/photo-1611891487122-207579d67d98?w=400&h=400&fit=crop', gradient: 'from-emerald-500 to-cyan-500', isMock: false },
  
  // Mock games - Popular
  { id: 'crash', name: 'Crash', category: ['popular', 'instant'], emoji: '📈', gradient: 'from-orange-500 to-red-600', isMock: true },
  { id: 'dice', name: 'Dice', category: ['popular', 'instant'], emoji: '🎯', gradient: 'from-violet-500 to-purple-600', isMock: true },
  { id: 'plinko', name: 'Plinko', category: ['instant', 'popular'], emoji: '🔮', gradient: 'from-pink-500 to-rose-600', isMock: true },
  ...
  >
    ...
    {game.image ? (
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <span className="text-5xl md:text-4xl drop-shadow-lg transition-transform duration-300 group-hover:scale-110">
          {game.emoji}
        </span>
      </div>
    )}
