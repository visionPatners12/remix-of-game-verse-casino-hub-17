...
const COLOR_STYLES: Record<string, { bg: string; border: string; ring: string; name: string }> = {
  R: { bg: 'bg-red-500', border: 'border-red-500', ring: 'ring-red-500', name: 'Red' },
  G: { bg: 'bg-green-500', border: 'border-green-500', ring: 'ring-green-500', name: 'Green' },
  Y: { bg: 'bg-yellow-500', border: 'border-yellow-500', ring: 'ring-yellow-500', name: 'Yellow' },
  B: { bg: 'bg-blue-500', border: 'border-blue-500', ring: 'ring-blue-500', name: 'Blue' },
};
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="space-y-2">
        {SLOT_ORDER.slice(0, maxPlayers).map((color) => {
          ...
          return (
            ...
            >
              ...
              {player ? (
                <Avatar className={cn("w-10 h-10 ring-2", colorStyle.ring)}>
